const entries = [
    {
        ...
        content: [
            ...
            "<u>Color Grading in Adobe Premiere Pro</u><br><ul><li>color grading is used to add style and <i>vibes</i></li><li>i used 2 tools to color grade my recordings<ul><li><i>hsl secondary:</i> allows you to select a color and “correct it” to a color of your</li><li><i>mask:</i> allows you to select a section of the image to add certain effects to it</li></ul></li><li>here are my thoughts on color grading my short film<ul><li>i wanted the beginning of the video to be bright & happy, so i enhanced the greens, blues, and oranges</li><li>as the video progressed, i started including more blues and decreased exposure to foreshadow rain and the end of the ride</li><li>at the end, i brought back the vibrant colors to symbolize warmth and home</li></ul></li></ul>",
            ...
            "Thanks for listening, I hope that this was somewhat informative. If you have any tips, ideas, comments, or concerns, feel free to respond to this email! I’d love to chat.",
            "- PJ",
            "",
            ""
        ]
